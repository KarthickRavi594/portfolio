            ...
            {selectedProject && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg w-full relative">
                        ...
                        <p className="mb-2"><span className="font-semibold">Organization:</span> {selectedProject.orgName}</p>
                        <p className="mb-2"><span className="font-semibold">Role:</span> {selectedProject.Role}</p>
                        <p className="mb-2"><span className="font-semibold">Responsibilities:</span> {selectedProject.responsibilities}</p>
                        <p className="mb-2"><span className="font-semibold">Description:</span> {selectedProject.description}</p>
                    </div>
                </div>
            )}
        </section>
